...
const ABI = ['function getDistributionRoute(bytes32 id) external view returns (tuple(uint256, bytes32, bool, bool, uint256))'];

const uuid = '44cf98a7-2203-4d09-8a93-0aa558fccb06';
...
async function main() {
    ...
    for (const [name, bytes32Value] of Object.entries(variants)) {
        ...
        try {
            ...
            if (route[0] > 0n || route[1] !== ethers.ZeroHash) {
