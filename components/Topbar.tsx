...
type TopbarProps = {
    activeTab?: 'play' | 'prices' | 'guide' | 'inventory' | 'my-packs' | 'shop' | 'leaderboard' | 'referrals' | 'history' | 'litepaper' | 'profile' | 'arena' | 'rewards'
    user?: {
        id?: string
        name?: string
        avatar?: string
    ...
    return (
        <header className="topbar">
            ...
            <nav className="tabs">
                ...
                <a className={`tab ${activeTab === 'rewards' ? 'active' : ''}`} href="/rewards" style={{ color: '#10b981' }}>💰 ARENA HISTORY</a>
